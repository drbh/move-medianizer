A simple move program that gets prices updates and returns a medianized value. This is mainly a way for me to learn more about Aptos and Move and should not be used in production.
